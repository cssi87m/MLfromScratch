...
class DecisionTree: 
    ...
    def _entropy(self, X: np.ndarray): 
        ''' 
        Calculate entropy of variable X
        '''
        hist = np.bincount(X) 
        ps = hist/len(X) 
    ...
    def _information_gain(self, y, X_column, threshold): 
        ...
        inform_gain = parent_entropy - child_entropy
        return inform_gain
    ...
    def _grow_tree(self, X, y, depth=0): 
        ...
        # find the best split 
        best_thr, best_feat = self._best_split(X, y, feat_idxs)
        # create child_node 
    ...
    def _best_split(self, X, y, feat_idxs): 
        ...
        for feat_idx in feat_idxs: 
            ...
            for threshold in thresholds: 
                ...
                gain = self._information_gain(threshold)
                if gain>best_gain: 
                    best_gain = gain 
                    split_idx = feat_idx
    ...
    def predict(self, ins): 
        '''
        instance: point need to predict
        '''
        return self._traverse_tree(ins, self.root)
